<?php /* Smarty version 2.6.20, created on 2010-05-24 12:32:56
         compiled from /Users/franzwilding/WEB/dev/twidoo/trunk/templates/invite.tpl */ ?>
				...
				<div class="left">
					<ul>
						...
						<li>
							...
							<textarea rows="10" cols="30" tabindex="2" id="text" name="invite[text]" onfocus="if(this.value=='<?php echo $this->_tpl_vars['logedinName']; ?>
 läd dich ein, gemeinsam die Website <?php echo $this->_tpl_vars['title']; ?>
 zu verwalten.')this.value=''" onblur="if(this.value=='')this.value='<?php echo $this->_tpl_vars['logedinName']; ?>
 läd dich ein, gemeinsam die Website <?php echo $this->_tpl_vars['title']; ?>
 zu verwalten.'"><?php echo $this->_tpl_vars['logedinName']; ?>
 läd dich ein, gemeinsam die Website <?php echo $this->_tpl_vars['title']; ?>
 zu verwalten.</textarea>
						</li>
					</ul>
				</div><!-- left ends here -->
